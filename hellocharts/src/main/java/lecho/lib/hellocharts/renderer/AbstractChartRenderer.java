...
public abstract class AbstractChartRenderer implements ChartRenderer {
    public final int DEFAULT_LABEL_MARGIN_DP = 4;
     ...
     */
    protected final Paint labelBackgroundPaint = new Paint();
    /**
     * Holds coordinates for label background rect.
     */
    protected final RectF labelBackgroundRect = new RectF();
    /**
     * Font metrics for label paint, used to determine text height.
     */
    protected final FontMetricsInt fontMetrics = new FontMetricsInt();
    /**
    ...
    protected final SelectedValue selectedValue = new SelectedValue();
    protected final char[] labelBuffer = new char[64];
    protected final int labelOffset;
    protected final int labelMargin;
