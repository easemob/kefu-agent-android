...
public class XhsEmoticonsKeyBoard_backup extends AutoHeightLayout implements View.OnClickListener, EmoticonsFuncView.OnEmoticonsPageViewListener,
...
//    protected EmoticonsAutoEditText mEtChat;
    ...
    public XhsEmoticonsKeyBoard_backup(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean requestFocus(int direction, Rect previouslyFocusedRect) {
        return !EmoticonsKeyboardUtils.isFullScreen((Activity) getContext()) && super.requestFocus(direction, previouslyFocusedRect);
    }
