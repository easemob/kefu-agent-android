...
public class XhsEmoticonsKeyBoard extends AutoHeightLayout implements View.OnClickListener, EmoticonsFuncView.OnEmoticonsPageViewListener,
        EmoticonsToolBarView.OnToolBarItemClickListener, FuncLayout.OnFuncChangeListener, EmoticonsAutoEditText.OnBackKeyClickListener {
    ...
    protected void initView() {
        ...
        mEtChat = (EmoticonsAutoEditText) findViewById(R.id.et_chat);
    ...
    public EmoticonsAutoEditText getEtChat() { return mEtChat; }
