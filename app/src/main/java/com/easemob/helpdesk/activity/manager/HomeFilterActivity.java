...
public class HomeFilterActivity extends BaseActivity implements SimplePickerView.SimplePickSelectItemListener {
    ...
    @BindView(R.id.rl_back) protected View tvBack;

    @BindView(R.id.right) protected TextView tvFilter;
    ...
    @BindView(R.id.rl_time) protected RelativeLayout rlTime;

    @BindView(R.id.rl_begintime) protected RelativeLayout rlBeginTime;

    @BindView(R.id.rl_endtime) protected RelativeLayout rlEndTime;

    @BindView(R.id.rl_channel) protected RelativeLayout rlChannel;

    @BindView(R.id.tv_time_text) protected TextView tvTimeText;

    @BindView(R.id.tv_begin_time) protected TextView tvBeginTime;

    @BindView(R.id.tv_end_time) protected TextView tvEndTime;

    @BindView(R.id.tv_channel_text) protected TextView tvChannelText;
    ...
    @OnClick(R.id.rl_back) protected void onClickByBack(View view) {
        finish();
    }

    @OnClick(R.id.right) protected void onClickByFilter(View view) {
    ...
    @OnClick(R.id.rl_time) protected void onClickByRlTime(View view) {
        closePickerView();
    ...
    @OnClick(R.id.rl_channel) protected void onClickByRlChannel(View view) {
        closePickerView();
    ...
    @OnClick(R.id.rl_begintime) protected void onClickByRlBeginTime(View view) {
        closePVTime();
    ...
    @OnClick(R.id.rl_endtime) protected void onClickByRlEndTime(View view) {
        closePVTime();
