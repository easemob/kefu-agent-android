...
/**
 * Created by liyuzhao on 16/2/25.
 */
public class SegmentTabActivity extends FragmentActivity {
    ...
    private String[] mTitles_4 = {"Ongoing","Agents"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout_6.setTabData(mTitles_4);
        ...
        tabLayout_5.showMsg(2, 15);
        tabLayout_5.setMsgMargin(2, -5, 5);

        tabLayout_6.showDot(1);
