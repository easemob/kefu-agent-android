...
public class RecorderVideoActivity extends BaseActivity implements
		...
		OnInfoListener{private static final String TAG = "RecorderVideoActivity";
	...
	private boolean initCamera() {
		try {
			...
			HDLog.e("video", "init Camera fail " + ex.getMessage());
			return false;
		}
		return true;
	}
	...
	public void surfaceCreated(SurfaceHolder holder) {
		...
		try {
			...
			HDLog.e("video", "start preview fail " + e1.getMessage());
			showFailDialog();
		}
	}
	...
	public void surfaceDestroyed(SurfaceHolder arg0) {
		HDLog.v("video", "surfaceDestroyed");
	}
	...
	public void stopRecording() {
		if (mediaRecorder != null) {
			...
			try {
				...
				HDLog.e("video", "stopRecording error:" + e.getMessage());
			}
		}
		releaseRecorder();
	...
	public void sendVideo(View view) {
		if (TextUtils.isEmpty(localPath)) {
			HDLog.e("Recorder", "recorder fail please try again!");
			return;
		}
		if(msc == null)
	...
	public void onInfo(MediaRecorder mr, int what, int extra) {
		HDLog.v("video", "onInfo");
		if (what == MediaRecorder.MEDIA_RECORDER_INFO_MAX_DURATION_REACHED) {
			HDLog.v("video", "max duration reached");
			stopRecording();
			btn_switch.setVisibility(View.VISIBLE);
			chronometer.stop();
			btnStart.setVisibility(View.VISIBLE);
	...
	public void onError(MediaRecorder mr, int what, int extra) {
		HDLog.e("video", "recording onError:");
		stopRecording();
		Toast.makeText(this,
