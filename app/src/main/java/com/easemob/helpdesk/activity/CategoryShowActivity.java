...
public class CategoryShowActivity extends BaseActivity {
    ...
    @BindView(R.id.right) protected TextView saveBtn;
    @BindView(R.id.iv_back) protected ImageView back;

    @BindView(R.id.et_comment) protected EditText etComment;

    @BindView(R.id.tag_group) protected TagView tagGroup;
    ...
    private void loadComment() {
        manager.asyncGetComment(new HDDataCallBack<String>() {
            @Override public void onSuccess(final String comment) {
                if (isFinishing()) {
                    return;
                }
    ...
    private void initView() {
        tagGroup.setOnTagDeleteListener(new OnTagDeleteListener() {
            @Override public void onTagDeleted(TagView view, Tag tag, int position) {
    ...
    public void add(View view) {
        startActivityForResult(new Intent(this, SelectCategoryTreeActivity.class).putExtra("sessionId", manager.getSessionId())
                .putExtra("ids", manager.getUnsavedCategorySummaryIds().toString()), REQUEST_CODE_ADD_CATEGORY);
