...
import com.easemob.helpdesk.fragment.main.NoticeFragment;
import com.easemob.helpdesk.fragment.main.WaitAccessFragment;
...
public class MainActivity extends BaseActivity {
    ...
    /**
     * CurrentSessionFragment (MainTab)
     */
    private CurrentSessionFragment mySessionFragment;
    ...
    private String[] mTitles = {"会话", "待接入", "通知"};
    ...
    private int[] mIconUnselectIds = {
            R.drawable.tabbar_icon_ongoing, R.drawable.tabbar_icon_waiter, R.drawable.tabbar_icon_notice
    };

    private int[] mIconIds = {R.id.tabbar_icon_ongoing, R.id.tabbar_icon_waiter, R.id.tabbar_icon_notice};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HDClient.getInstance().chatManager().getTenantOptions();
        getTechChannel();
        getInitData();
    ...
    private void configureSlidingMenu() {
        ...
        homeItem.count = 0;
        homeItem.iconName = "{fon-nav_session_normal}";
        homeItem.title = "主界面";
        ...
        historyItem.count = 0;
        historyItem.iconName = "{fon-nav_history_normal}";
        ...
        settingItem.count = 0;
        settingItem.iconName = "{fon-profile}";
        ...
        menu.setOnOpenedListener(new SlidingMenu.OnOpenedListener() {
            ...
            public void onOpened() {
                ...
                refreshHomeCount();
                if (ivAvatar != null) {
                    AvatarUtils.refreshAgentAvatar(MainActivity.this, ivAvatar);
                }
    ...
    public void refreshHomeCount() {
        ...
        int totalCount = 0;
        if (mySessionFragment != null) {
            totalCount += mySessionFragment.getUnreadCount();
        }
    ...
    public void refreshSessionUnreadCount() {
        if (mySessionFragment != null) {
            int count = mySessionFragment.getUnreadCount();
...
//                CommonUtils.handleBadge(this, 0);
    ...
    private void initView() {
        ...
        mFragments.clear();
        if (mySessionFragment == null){
            mySessionFragment = new CurrentSessionFragment();
        }
        if (mWaitAccessFragment == null){
    ...
    public void tipNoticeCenterRefresh() {
        HDNotifier.getInstance().notifiChatMsg(null);
        if (mNoticeFragment != null){
            mNoticeFragment.refreshTabUnreadCount();
        }
    }
