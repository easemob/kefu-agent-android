...
import com.easemob.helpdesk.adapter.PhraseListAdapter;
...
public class PhraseListActivity extends BaseActivity {
    ...
    private static class WeakHandler extends android.os.Handler {
        WeakReference<PhraseListActivity> weakReference;

        public WeakHandler(PhraseListActivity activity) {
            this.weakReference = new WeakReference<PhraseListActivity>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            super.handleMessage(msg);
            PhraseListActivity activity = weakReference.get();
            if (null != activity) {
                switch (msg.what) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setAdapterWithProgress(mAdapter = new PhraseListAdapter(this));
        mAdapter.setOnItemClickListener(new RecyclerArrayAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int i) {
                ...
                intent.setClass(PhraseListActivity.this, PhraseItemActivity.class);
