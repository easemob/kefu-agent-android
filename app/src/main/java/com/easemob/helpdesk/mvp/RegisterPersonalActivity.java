        ...
        HDClient.getInstance().accountManager().postImgVerifyCode(new HDDataCallBack<Bitmap>() {
            ...
            public void onError(int error, String errorMsg) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        hideDialog();
                        Toast.makeText(RegisterPersonalActivity.this, "加载验证码失败!", Toast.LENGTH_SHORT).show();
                    }
                });
            }
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            if (jsonObject.has("error")) {
                                ...
                                Toast.makeText(RegisterPersonalActivity.this, "" + error, Toast.LENGTH_SHORT).show();
                                loadVerifyCode();
                                return;
                            }
...
//                                String success = jsonObject.getString("success");
            ...
            public void onError(int error, String errorMsg) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        hideDialog();
                        Toast.makeText(RegisterPersonalActivity.this, "提交失败,请检查网络!", Toast.LENGTH_SHORT).show();
                    }
                });
            }
