package com.easemob.helpdesk.widget.dialog;
...
public class InputDialog {
     ...
     * also call your {@link android.content.DialogInterface.OnCancelListener} (if registered).
     */
    public void cancel() {
        if (dialog != null)
            dialog.cancel();
    ...
    public interface ButtonActionIntercepter {
         ...
         *                    DialogInterface.BUTTON_NEGATIVE, DialogInterface.BUTTON_NEUTAL
