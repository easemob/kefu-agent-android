package com.easemob.helpdesk.widget.dashboardview;
...
public class DashboardView extends View {
    ...
    private String mHeaderText = "今日接待人数/最大"; // 表头
    ...
    protected void onDraw(Canvas canvas) {
         ...
         * 画指针
         */
        float θ = mMax - mMin == 0 ? mStartAngle : mStartAngle + mSweepAngle * (mRealTimeValue - mMin) / (mMax - mMin); // 指针与水平线夹角
        ...
        if (isShowValue) {
            ...
            mPaint.setTextAlign(Paint.Align.CENTER);
            mPaint.setColor(ContextCompat.getColor(getContext(), R.color.colorPrimary));
            String value = String.valueOf(mRealTimeValue + "/" + mMax);
