...
public class AnimEmoticonsIndicatorView extends EmoticonsIndicatorView {
    ...
    public void playTo(int position, PageSetEntity pageSetEntity) {
        ...
        mPlayToAnimatorSet = new com.nineoldandroids.animation.AnimatorSet();
    ...
    public void playBy(int startPosition, int nextPosition, PageSetEntity pageSetEntity) {
        ...
        mPlayByOutAnimatorSet = new com.nineoldandroids.animation.AnimatorSet();
        ...
        mPlayByInAnimatorSet = new com.nineoldandroids.animation.AnimatorSet();
        ...
        anim1.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                com.nineoldandroids.animation.AnimatorSet mFillAnimatorSet = new com.nineoldandroids.animation.AnimatorSet();
